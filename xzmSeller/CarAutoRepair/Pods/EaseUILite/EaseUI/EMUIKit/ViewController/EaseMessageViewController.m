...
#pragma a 消息显示用户昵称和头像
    ...
    dic[@"userNickName"] = [[NSUserDefaults standardUserDefaults] objectForKey:@"usernickname"];
    dic[@"userHeadImage"] = [[NSUserDefaults standardUserDefaults] objectForKey:@"userPicture"];
