    ...
    [self.netWork asyncAFNPOST:Regist_Url Param:arr Success:^(id responseObjc, NSError *codeErr) {
        ...
        if (!code)
        {
            ...
            dispatch_async(dispatch_get_global_queue(0, 0), ^{
                ...
                EMError *error1 = [[EMClient sharedClient] registerWithUsername:[@"SELL" stringByAppendingString:responseObjc] password:str];
                if (error1==nil) {
                    NSLog(@"注册成功");
                } else {
        ...
        {
            [MBProgressHUD alertHUDInView:self.view Text:@"两次密码不一致"];
        }
