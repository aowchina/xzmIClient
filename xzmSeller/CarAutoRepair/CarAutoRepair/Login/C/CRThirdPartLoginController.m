                ...
                if (!codeErr) {
                    ...
                    dispatch_async(dispatch_get_global_queue(0, 0), ^{
                        ...
                        if (error1==nil) {
                            ...
                            EMError *error = [[EMClient sharedClient] loginWithUsername:[@"SELL" stringByAppendingString:responseObjc[@"userid"]] password:user.uid];
                            if (!error) {
                                
                                NSLog(@"登录成功");
                            } else {
                                
                                EMError *error1 = [[EMClient sharedClient] registerWithUsername:[@"SELL" stringByAppendingString:responseObjc[@"userid"]] password:user.uid];
                            }
