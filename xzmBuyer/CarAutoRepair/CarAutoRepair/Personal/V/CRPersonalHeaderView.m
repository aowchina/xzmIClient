...
@property (weak, nonatomic) IBOutlet UIButton *fahuo1_btn;
@property (weak, nonatomic) IBOutlet UIButton *shouh1_btn;
@property (weak, nonatomic) IBOutlet UIButton *pingjia1_btn;
...
- (void)awakeFromNib {
    ...
    if (kScreenWidth > 320) {
        ...
        self.fahuo1_btn.imageEdgeInsets = UIEdgeInsetsMake( - 20, 28, 0, 0);
        self.shouh1_btn.imageEdgeInsets = UIEdgeInsetsMake( - 20, 30, 0, 0);
        self.pingjia1_btn.imageEdgeInsets = UIEdgeInsetsMake( - 20, 28, 0, 0);
    }
