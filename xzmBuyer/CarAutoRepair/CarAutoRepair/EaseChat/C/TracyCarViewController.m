...
- (void)viewDidLoad {
    ...
    [[NSNotificationCenter defaultCenter] addObserver:self selector:@selector(receiveBuyNoti:) name:@"sendBuyMessage" object:nil];
}

- (void)receiveBuyNoti:(NSNotification *)noti {
