...
- (void)viewDidLoad {
    ...
    CRShopMarketController *shopMarketVC = [[CRShopMarketController alloc] init];
    [self addChildViewController:shopMarketVC title:@"商城" image:@"qixiu_shangcheng" selectImage:@"s_qixiu_shangcheng"];
