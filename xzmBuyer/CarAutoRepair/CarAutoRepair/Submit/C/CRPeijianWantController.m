        ...
        if (!code)
        {
            ...
            if (iType == 1) {/** 标识为1有数据 */
                ...
                if (array.count > 0) {
                    ...
                    self.vinModel = [CRCarDetailModel mj_objectWithKeyValues:dic];
                    self.vinModel.vin = textF;
            
            self.vinModel.popType = @"VIN";
                
                self.vinModel.cimage = responseObjc[@"cimage"];
...
//    [cell reloadDataWithCarType:self.vinModel];
