...
- (void)leftBarButtonItemAction {
    ...
    if (self.peijianType == 1 || self.peijianType == 2) {
...
//    }
    ...
    NSArray *array = @[kHDUserId,str,self.typeID,self.bianmaF.text,self.moneyF.text,self.phoneF.text,[SuperHelper changeStringUTF:self.proDetailTextV.text],[SuperHelper changeStringUTF:self.nameF.text]];
    ...
    if (self.peijianType == 2) {
        ...
        array = @[kHDUserId,str,self.typeID,self.bianmaF.text,self.moneyF.text,self.phoneF.text,[SuperHelper changeStringUTF:self.proDetailTextV.text],[SuperHelper changeStringUTF:self.nameF.text],self.goodid,str1];
        
    }
    
    [self showHud];
    
    [self.netWork asyncPhotoListForPersonWithImageArray:self.imageDataAry parameterArray:array url:goods_AddUrl success:^(id responseObjc) {
...
- (void)typeTapAction {
    ...
    carTypeC.returnTypeBlock = ^(NSString *str,NSString *iD) {
