...
- (void)tableView:(UITableView *)tableView didSelectRowAtIndexPath:(NSIndexPath *)indexPath {
    ...
    CRAccOfferViewController *AccOfferViewC = [[CRAccOfferViewController alloc] init];
    
    AccOfferViewC.bid = model.bid;
    
    AccOfferViewC.hidesBottomBarWhenPushed = YES;
    [self.navigationController pushViewController:AccOfferViewC animated:YES];
